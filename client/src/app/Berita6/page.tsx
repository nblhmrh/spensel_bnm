  ...
  useEffect(() => {
    const fetchBerita = async () => {
      try {
        ...
        const berita6Data = response.data.find((item: Berita) =>
          item.slug && item.slug.toLowerCase().includes('berita6')
        );
        setBerita(berita6Data || null);
      } catch (error) {
      ...
      <div className="bg-[#154472] w-full h-[300px]">
        ...
        <section className="flex flex-col py-8 px-6">
          ...
          <p className="text-white mt-2 py-3 font-normal">
            ...
            &gt;{" "}
            <Link href="/berita6" className="hover:text-gray-300">
              Berita 6
            </Link>
          </p>
        </section>
