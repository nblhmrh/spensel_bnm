    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="text-white mt-2 py-3 font-normal font-inter">
            ...
            &gt;{" "}
            <Link href="/struktur" className="hover:text-gray-300 transition-colors duration-300">
              Struktur Organisasi
            </Link>
          </p>
        </motion.section>
      ...
      >
        ...
        >
          ...
          >
            Mari kita mengenal lebih dekat siapa saja yang berperan penting dalam menjalankan
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 justify-center">
                ...
                >
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    href={`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/struktur/download/${item.file.split('/').pop()}`}
